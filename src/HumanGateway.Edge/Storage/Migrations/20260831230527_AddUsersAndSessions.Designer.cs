...
namespace HumanGateway.Edge.Storage.Migrations
{
    ...
    [Migration("20260831230527_AddUsersAndSessions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HumanGateway.Edge.Storage.Entities.HumanTaskRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RequestMessageId")
                        .HasDatabaseName("ix_tasks_request_message_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_tasks_status");

                    b.HasIndex("WorkflowRef")
                        .HasDatabaseName("ix_tasks_workflow_ref");
