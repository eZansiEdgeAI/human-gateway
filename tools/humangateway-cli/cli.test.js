...
test('requires compose bootstrap credentials', () => assert.throws(() => validateConfig({ mode: 'compose', gatewayId: 'edge:test', edgePort: '8080', relayPort: '5275', dbPort: '127.0.0.1:5433', relayUrl: 'http://127.0.0.1:5275' })));
